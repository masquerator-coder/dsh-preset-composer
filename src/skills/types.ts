/**
 * Structural (type-only) contracts for the small dsh service surface the
 * preset-skills runtime consumes. Kept local so the bundled output needs no
 * runtime `@deepseek-ai/*` resolution beyond what the loader injects.
 *
 * Ported from dsh-preset-skills v4.3.0 into dsh-preset-composer.
 *
 * @module dsh-preset-composer/skills/types
 */
